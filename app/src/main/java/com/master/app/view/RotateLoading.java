...
public class RotateLoading extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        loadingRectF = new RectF(width * 2, width * 2, w - 2 * width, h - 2 * width);
        shadowRectF = new RectF(width * 2 + shadowPosition, width * 2 + shadowPosition, w - width * 2 + shadowPosition, h - width * 2 + shadowPosition);
    }
